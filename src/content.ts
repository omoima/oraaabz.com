/** Edit this file to update the words and links on the site. */
export const content = {
  name: 'Oarabile Moima',
  nickname: 'ORAAABZ',
  location: 'Cape Town, South Africa',
  email: 'oarabilemoima@gmail.com',
  github: 'https://github.com/omoima',
  linkedin: 'https://www.linkedin.com/in/oarabile-moima/',
  instagram: 'https://instagram.com/oraaabz',
  twitter: 'https://x.com/oraaabz',
  heading: 'Oarabile Moima.',
  intro:
    'I’m an enthusiastic problem solver. I like improving things, getting the most out of what I do, and seeing an idea come to life — especially when it helps someone.',
  current:
